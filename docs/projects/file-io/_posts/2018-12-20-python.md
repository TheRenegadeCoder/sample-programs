...
Afterward, we'll take a look at how to run the solution.[^1]
...
files when you are finished using them.[^1]
...
And, that's it! We've conquered File IO in Python.[^1]
...
[^1]: N. Nichols, “File IO in Python,” The Renegade Coder, 2-Nov-2018. [Online]. Available: <https://therenegadecoder.com/code/file-io-in-python/>. [Accessed: 20-Dec-2018].
