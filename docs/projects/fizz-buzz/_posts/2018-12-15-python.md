...
of checking whether i % 3 == 0 or i % 5 == 0.[^1]
...
what type a variable should be on the fly.[^1]
...
Here, we loop through all the numbers from 1 to 100.[^1]
...
undefined, null, and '' all return false when they’re used in logical comparisons.[^1]
...
line containing any junk from the previous iteration.[^1]
...
interpreter and hit run.[^1]

---

#### References

[^1]: J. Mason, “Fizz Buzz in Python,” The Renegade Coder, 31-Aug-2018. [Online]. Available: <https://therenegadecoder.com/code/fizz-buzz-in-python/>. [Accessed: 11-Dec-2018].
